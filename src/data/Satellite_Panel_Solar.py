...
class Panel_Solar():
    ...
    def __init__(self, name):
        ...
        # Voltaje [V]
        self.psolar_tension = 0.
        # Intensidad [mA]
        self.psolar_intensidad = 0.
        # Eficiencia [%]
        self.psolar_eficiencia = 28.

        # Masa del panel solar [kg]
        self.psolar_masa = 0.1
        # Area del panel solar [cm2]
        self.psolar_area = 0

        # Rendimiento del panel en funcion de la incidencia solar [%]
        self.psolar_rendimiento = 0.28
        # Estado del panel
    ...
    def psolar(self):
        print(self.psolar_tipo, "\nMasa:", self.psolar_masa, "kg", "\nTension:",
              self.psolar_tension, "V", "  Intensidad:", self.psolar_intensidad, "mA")

    def psolar_estado(self):
        print("Panel solar", self.nombre, ": ",
              "Generando:", self.psolar_generando)
