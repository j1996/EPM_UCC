...
class Bateria():
    ...
    def __init__(self):
        ...
        self.bat_capacidad = 2200                                                                                                              # Capacidad [mAh]
        self.bat_tension = 0.                                                                                                                      # Voltaje [V]
        self.bat_intensidad = 0.                                                                                                               # Intensidad [mA]
                
        self.bat_masa = 0.                                                                                                           # Masa de las baterias [kg]
        self.bat_volumen = 0.                                                                                                    # Volumen de las baterias [cm3] 

        self.bat_nivelcarga = 50.                                                                                                         # Nivel de batería [%]
        self.bat_cargando = False                                                                                              # Estado de la bateria ¿cargando?
        self.bat_descargando = False                                                                                        # Estado de la bateria ¿descargando?
        self.bat_rendimiento = 1.                                                                                                  # Rendimiento [tanto por uno]
        self.bat_ciclos = 0                                                                                                           # Ciclos de carga/descarga
    ...
    def bateria_carga(self,t,t0):
        ...
        carg = (0)/self.bat_capacidad*100             # Donde el 0 debemos poner la ecuacion de la carga
        ...
        self.bat_cicloestado = self.bat_cicloestado + carg                             #  segun van sucediendose los ciclos de carga
        if self.bat_cicloestado >= (100*self.bat_rendimiento):                         # Un ciclo se alcanza cuando las repetidas cargas acumulan el 100% de la
            self.bat_cicloestado = self.bat_cicloestado - 100*self.bat_rendimiento     #  capacidad de la bateria, y eso es lo que hacemos aqui. Luego, variamos
            self.bat_ciclos = self.bat_ciclos + 1                                      #  el rendimiento de la bateria  siguiendo el criterio de que cada 100
        self.bat_rendimiento = self.bat_rendimiento - (0.05/100)*self.bat_ciclos       #  ciclos, el rendimiento cae un 5%.
    ...
    def bateria_descarga(self,t,t0):
        ...
        descarg = (0)/self.bat_capacidad*100          # Donde el 0 debemos poner la ecuacion de la descarga
    ...
    """
    def bateria(self):
        print(self.bat_tipo,"\nMasa:",self.bat_masa,"kg","  Volumen:",self.bat_volumen,"cm3","\nTension:",self.bat_tension,"V","  Intensidad:",self.bat_intensidad,"mA","  Capacidad:",self.bat_capacidad,"mAh")
    
    def bateria_estado(self):
        print("BATERIA")
        print("Nivel de carga:",self.bat_nivelcarga,"%","   Salud de bateria:",self.bat_rendimiento*100,"%","\n   Cargando:",self.bat_cargando,"   Descargando:",self.bat_descargando)
